...
exports.resendWelcomeEmail = exports.onUserCreated = exports.processCheckIn = exports.activateStudent = exports.createStudentOnboarding = void 0;
const functions = __importStar(require("firebase-functions"));
const admin = __importStar(require("firebase-admin"));
admin.initializeApp();
const db = admin.firestore();
exports.createStudentOnboarding = functions.https.onCall(async (data, context) => {
    try {
        if (!context.auth) {
        ...
        if (!email || !displayName || !planId) {
            throw new functions.https.HttpsError("invalid-argument", "Faltan campos obligatorios: correo, nombre o plan.");
        }
        ...
        try {
            ...
            resetLink = defaultLink.replace("terayoga-estudio.firebaseapp.com/__/auth/action", "terayoga-estudio.web.app/auth/action");
        }
        catch (resetError) {
