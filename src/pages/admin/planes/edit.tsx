...
export default function EditPlan() {
    ...
    if (isLoading) {
        return <div className="flex h-screen items-center justify-center">Cargando plan...</div>
    }
                ...
                <header className="flex h-16 shrink-0 items-center gap-2 border-b px-4">
                    ...
                    <Breadcrumb>
                        <BreadcrumbList>
                            ...
                            <BreadcrumbSeparator className="hidden md:block" />
                            <BreadcrumbItem>
                                <BreadcrumbPage>Editar Plan</BreadcrumbPage>
                            </BreadcrumbItem>
                        </BreadcrumbList>
                    </Breadcrumb>
                </header>
                ...
                <main className="flex flex-1 flex-col items-center justify-start p-6 bg-[#F9FAF7]">
                    <div className="w-full max-w-2xl">
                        <div className="flex items-center gap-4 mb-8">
                            ...
                            <h1 className="text-3xl font-serif font-bold text-[#1E293B]">Editar Plan</h1>
                        </div>

                        <Card className="border-none shadow-lg bg-white overflow-hidden">
                            <div className="h-2 bg-[#E8F5E9]" />
                            <CardHeader>
                                <CardTitle className="font-serif">Actualizar Membresía</CardTitle>
                                <CardDescription>
                                    Modifica los parámetros del plan existente.
                                </CardDescription>
                            </CardHeader>
                                ...
                                <CardContent className="space-y-6">
                                    ...
                                    {success && (
                                        <div className="p-3 bg-green-50 text-green-700 rounded-lg text-sm border border-green-100 animate-in fade-in slide-in-from-top-1">
                                            Plan actualizado con éxito. Redirigiendo...
                                        </div>
                                    )}
                                </CardContent>
